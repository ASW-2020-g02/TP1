...
public class Situacion {
	...
	/**
	 * Setter del ID de la situación. Recibe una cadena y verifica que pueda convertirse a número entero.
	 * 
	 * @param id (string) cadena que contiene el id de la situacion
	 * @throws Exception en caso de que la cadena recibida no pueda convertirse a número entero.
	 */
	...
	/**
	 * Setter del código del paciente. Recibe una cadena y verifica que pueda convertirse a número entero.
	 * 
	...
	/**
	 * Setter del código del médico. Recibe una cadena y realiza verificaciones sobre la misma.
	 * 
	...
	/**
	 * Setter del diagnóstico. Verifica que la cadena recibida no sea nula ni sea solo espacios en blancos.
	 * 
