...
public class Medico {
	 ...
	 * válidos.
	 * 
	 * Arroja excepciones en caso de que el nombre contenga caracteres no válidos o
	...
	public void setEspecialidad(String especialidad) throws Exception {
		// Chequeamos si la cadena recibida es nula o si es solo una cadena que contiene
		// caracteres
		// vacios
