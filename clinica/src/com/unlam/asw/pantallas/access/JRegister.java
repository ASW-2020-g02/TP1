		...
		if (!existeUsuario(strEmail)) {
			...
			if (strNombre.length() <= 50) {
				try {
					...
					JOptionPane.showMessageDialog(null, "Usuario registrado con �xito en la base de datos.",
				...
				JOptionPane.showMessageDialog(null, "El nombre se encuentra vac�o o es muy grande.", "Error",
						JOptionPane.INFORMATION_MESSAGE);
			}
		} else {
