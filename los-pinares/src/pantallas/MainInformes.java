...
public class MainInformes extends JFrame {
	...
	public MainInformes() {
		...
		cboMedicos.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				ArrayList<Paciente> pacientesXmedico = buscarPacientesPorMedico(Integer.parseInt(cadmed[0]), situPac, pacientes);
		...
		JLabel lblPacientesAtendidos = new JLabel("Pacientes atendidos (haga doble-click sobre el paciente para ver los diagn\u00F3sticos):");
	...
	private ArrayList<Paciente> buscarPacientesPorMedico(int codMed,ArrayList<SituacionPaciente> situPac,ArrayList<Paciente> pacientes)	
	{
