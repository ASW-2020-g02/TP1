		...
		btnAceptar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					SituacionPaciente sp = new SituacionPaciente(Integer.parseInt(cadpac[0]),
							Integer.parseInt(cadmed[0]), txtpnDiagnostico.getText());
					registrarSituacionPaciente(sp);
					JOptionPane.showMessageDialog(null, "¡Diagnóstico realizado correctamente!", "Confirmación",
	...
	private void registrarSituacionPaciente(SituacionPaciente sp) {
		try {
			...
			String registro = Encriptacion
					.Encriptar(sp.getCodpaciente() + "," + sp.getCodmedico() + "," + sp.getSituacion());
